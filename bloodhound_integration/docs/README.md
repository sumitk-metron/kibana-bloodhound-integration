...
# BloodHound Integration Integration for Elastic

## Overview

The BloodHound Integration integration for Elastic enables collection of ...
...
The BloodHound Integration integration collects log messages of the following types:
* ...
